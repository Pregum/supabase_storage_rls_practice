...
class RemoveOptionForm extends HookConsumerWidget {
  const RemoveOptionForm({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final parentParameter = ref.watch(playGroundViewModelProvider);
    final parameter = useState<RemoveCommandParameter>(
        parentParameter as RemoveCommandParameter);
    ...
    return Form(
      child: Column(
        children: [
          ...
          const Gap(24),
          const Text('削除対象のファイルパスを入力してください'),
          SimpleRadioButton(
            defaultValue: '',
